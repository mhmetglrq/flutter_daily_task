...
import 'package:flutter_daily_task/features/dailyTask/presentation/bloc/project/remote/remote_project_state.dart';
...
class _ProjectState extends State<Project> {
  ...
  Widget build(BuildContext context) {
    ...
    DateTime now = DateTime.now();
    return Scaffold(
      body: BlocBuilder<RemoteProjectBloc, RemoteProjectState>(
